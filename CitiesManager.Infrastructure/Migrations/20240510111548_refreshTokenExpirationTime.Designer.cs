...
namespace CitiesManager.Infrastructure.Migrations
{
    ...
    [Migration("20240510111548_refreshTokenExpirationTime")]
            ...
            modelBuilder.Entity("CitiesManager.Core.Models.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CityID = new Guid("f012f6f3-5267-430a-b89b-54aaa83be11e"),
                            CityName = "New York"
                        },
                        new
                        {
                            CityID = new Guid("56aa9698-c9b8-45db-87ab-24904f030df3"),
                            CityName = "London"
                        });
                });
